...
class XMovableProcInterpolation : public XMovableProcessor
{
private:
	XModuleMovable* m_pModuleMovable;

public:
	XMovableProcInterpolation();
	virtual ~XMovableProcInterpolation();
	...
	virtual const wchar_t* GetDebugName() { return L"Interpolation"; }
};
