...
void AddMaster2GameCommandTable()
{
	...
	C(MMC_PARTY_INVITE_BY_NAME_REQ,						MCDT_SERVER2SERVER, MCF_C2S, "Party Invite By Name Req")
														P(MPT_WSTR, "strTargetPlayer")
														P(MPT_UID, "uidRequestPlayer")
	...
	C(MMC_PARTY_JOIN_REQ,								MCDT_SERVER2SERVER, MCF_C2S, "Party Join Req")
														P(MPT_UID, "uidParty")
														P(MPT_UID, "uidRequestPlayer")
														P(MPT_INT, "nReqPlayerLevel")
														P(MPT_INT, "nReqPlayerTalentStyle")

	C(MMC_PARTY_JOIN_RES,								MCDT_SERVER2SERVER, MCF_S2C, "Party Join Res")
														P(MPT_UID, "uidRequestPlayer")
														P(MPT_INT, "nResult")
	...
	C(MMC_PARTY_CREATE_SINGLE_PARTY_REQ,				MCDT_SERVER2SERVER, MCF_C2S, "Party Create Single Party Req")
														P(MPT_UID,	"uidRequestPlayer")
														P(MPT_BOOL,	"bPublic")
														P(MPT_WSTR,	"strPartyName")

	C(MMC_PARTY_CREATE_SINGLE_PARTY_RES,				MCDT_SERVER2SERVER, MCF_S2C, "Party Create Single Party Res")
														P(MPT_UID,	"uidRequestPlayer")
	...
	C(MMC_PARTY_CHANGE_PUBLIC_PARTY_SETTING_REQ,		MCDT_SERVER2SERVER,	MCF_C2S, "Party.Change Public Party Setting Req.")
														P(MPT_UID,			"uidParty")
														P(MPT_UID,			"uidLeader")
														P(MPT_BOOL,			"bPublic")
														P(MPT_WSTR,			"strPartyName")

	C(MMC_PARTY_CHANGE_PUBLIC_PARTY_SETTING,			MCDT_SERVER2SERVER, MCF_S2C, "Party.Change Public Party Setting")
														P(MPT_UID,			"uidParty")
														P(MPT_BOOL,			"bPublic")
														P(MPT_WSTR,			"strPartyName")
	...
	C(MMC_PARTY_SHOW_INFO_REQ,							MCDT_SERVER2SERVER, MCF_C2S, "Party.Show Info Req")
														P(MPT_UID,			"uidRequestor")
														P(MPT_UID,			"uidParty")

	C(MMC_PARTY_SHOW_INFO_RES,							MCDT_SERVER2SERVER, MCF_S2C, "Party.Show Info Res")
														P(MPT_UID,			"uidRequestor")
														P(MPT_BLOB,			"Party")
														P(MPT_BLOB,			"vecPartyMember")

	C(MMC_PARTY_MATCHING_SHOW_PUBLIC_PARTY_LIST_REQ,	MCDT_SERVER2SERVER, MCF_C2S, "Party.Matching Show Public Party List Req")
														P(MPT_UID,			"uidRequestor")
														P(MPT_CHAR,			"nPage")
	...
	C(MMC_PARTY_MATCHING_SHOW_PUBLIC_PARTY_LIST_RES,	MCDT_SERVER2SERVER, MCF_S2C, "Party.Matching Show Public Party List Res")
														P(MPT_UID,			"uidRequestor")
														P(MPT_INT,			"result")
...
void AddMaster2LoginCommandTable()
{
	...
	C(MLC_PLAYER_PWE_ADD_PLAYER_REQ,					MCDT_SERVER2SERVER, MCF_C2S, "Request PWE Add Player")
														P(MPT_UID,		"PlayerUID")
														P(MPT_INT64,	"AID")
														P(MPT_WSTR,		"UserID")

	C(MLC_PLAYER_PWE_ADD_PLAYER_RES,					MCDT_SERVER2SERVER, MCF_S2C, "Response PWE Add Player")
														P(MPT_UID,	"PlayerUID")
														P(MPT_INT,	"nResult")
