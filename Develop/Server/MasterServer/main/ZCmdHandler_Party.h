...
public:
	...
	DECL_CMD_HANDLER(OnPartyInviteByNameReq);
	...
	DECL_CMD_HANDLER(OnPartyJoinReq);
	...
	DECL_CMD_HANDLER(OnPartyChangePublicPartySettingReq);
	...
	DECL_CMD_HANDLER(OnPartyShowInfoReq);
	DECL_CMD_HANDLER(OnPartyCreateSinglePartyReq);
	DECL_CMD_HANDLER(OnPartyShowMatchingPublicPartyListReq);
