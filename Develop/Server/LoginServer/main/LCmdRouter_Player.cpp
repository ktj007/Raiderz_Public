...
void LCmdRouter_Player::PostPWEAddPlayerReq(const MUID& uidPlayer, AID nAID, const wstring& strUserID)
{
	minet::MCommand* pNewCommand = gsys.pServer->GetMasterClient()->MakeNewSendCommand(MLC_PLAYER_PWE_ADD_PLAYER_REQ
		, 3
		, NEW_UID(uidPlayer)
		, NEW_INT64(nAID)
		, NEW_WSTR(strUserID.c_str()));
