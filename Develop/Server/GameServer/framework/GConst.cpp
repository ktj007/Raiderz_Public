...
float	GConst::INACTIVE_SHAREDFIELD_NPC_CLEARTIME			= 300.0f;
...
int		GConst::FIRST_ENTER_FIELD_ID					= 109;
int		GConst::FIRST_TUTORIAL_FIELD_ID					= 1090000;
int		GConst::FIRST_ENTER_MARKER_ID					= 1;
...
int		GConst::DISMOUNT_BUFFID = INVALID_ID;

float	GConst::TALENT_CRITICAL_DAMAGE_APPLY_RATE = 1.5f;
...
// Party
float	GConst::PARTY_MEMBER_POSITION_TICK = 1.5f;
...
int		GConst::SERVER_SLEEP_DURATION = 10;
...
void GConst::Init(MWLua* pLua)
{
	...
	GET_LUA_VAR(float, "INACTIVE_SHAREDFIELD_NPC_CLEARTIME",	INACTIVE_SHAREDFIELD_NPC_CLEARTIME);
	...
	GET_LUA_VAR(float, "TALENT_CRITICAL_DAMAGE_APPLY_RATE",		TALENT_CRITICAL_DAMAGE_APPLY_RATE);
	...
	GET_LUA_VAR(int, "FIRST_ENTER_MARKER_ID",				FIRST_ENTER_MARKER_ID);
	...
	GET_LUA_VAR(int, "DISMOUNT_BUFFID",	DISMOUNT_BUFFID);
	...
	// Party
	GET_LUA_VAR(float,	"PARTY_MEMBER_POSITION_TICK",				PARTY_MEMBER_POSITION_TICK);
	...
	GET_LUA_VAR(int,	"SERVER_SLEEP_DURATION",					SERVER_SLEEP_DURATION);
...
int GConst::GetFirstEnterFieldID()
{
	...
	{
		return GConst::FIRST_TUTORIAL_FIELD_ID;
	}
	else
	{
		return GConst::FIRST_ENTER_FIELD_ID;
	}
}
