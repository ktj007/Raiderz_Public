...
public :
	...
	{
		TDBRecordSet rs;
		UTestDB.Execute(rs, L"SELECT CHAR_PTM, DELTA_CHAR_PTM, LEV, CUR_MONEY, DELTA_MONEY, NPC_ID FROM dbo.RZ_ITEM_LOG WHERE ACCN_ID = %I64d AND OWNER_ID = %I64d AND CODE = %d"
			, m_GSN, m_CSN, m_CODE);
