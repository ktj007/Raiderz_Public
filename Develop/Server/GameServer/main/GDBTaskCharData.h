...
public :
	...
	GDBT_CHAR_XP_DATA(const AID nAID, const MUID& uidPlayer, const CID nCID, int nCode, const wstring& strRegDate, const int nXP, const int nModXP, const uint8 nLevel, const int nMoney, const int nCharPtm, int nDeltaCharPtm, int nNpcID)
...
{
public :
	GDBT_CHAR_LEVEL_UP_DATA() : m_nRemainTP(0), m_nDeltaTP(0), m_nFieldID(0), m_vPos(vec3::ZERO) {}
	GDBT_CHAR_LEVEL_UP_DATA(const AID nAID, const MUID& uidPlayer, const CID nCID, int nCode, const wstring& strRegDate, const int nXP, const int nModXP, const uint8 nLevel, const int nMoney
		, const int16 nRemainTP, const int16 nDeltaTP, const int nCharPtm, int nDeltaCharPtm, int nNpcID, int nFieldID, const vec3& vPos)
		: GDBT_CHAR_XP_DATA(nAID, uidPlayer, nCID, nCode, strRegDate, nXP, nModXP, nLevel, nMoney, nCharPtm, nDeltaCharPtm, nNpcID), m_nRemainTP(nRemainTP), m_nDeltaTP(nDeltaTP), m_nFieldID(nFieldID), m_vPos(vPos) {}
...
{
public :
	GDBT_CHAR_ENTER_FILED(const AID nAID, const CID nCID, const int nXP, const uint8 nLevel, const int nMoney, const int nCharPtm
		, const int nSharedFieldID, const float fPosX, const float fPosY, const float fPosZ,  const float fDirX, const float fDirY, const float fDirZ)
		: m_nAID(nAID), m_nCID(nCID), m_nXP(nXP), m_nLevel(nLevel), m_nMoney(nMoney), m_nCharPtm(nCharPtm)
	, m_nSharedFieldID(nSharedFieldID), m_fPosX(fPosX), m_fPosY(fPosY), m_fPosZ(fPosZ), m_fDirX(fDirX), m_fDirY(fDirY), m_fDirZ(fDirZ) {}
...
public :
	...
	GDBT_CHAR_DELETE(const AID nAID, const MUID& uidPlayer, const CID nCID, const int nIndex)
...
public :
	...
	GDBT_CHAR_SERIALIZE(const AID nAID, const MUID& uidPlayer, const UIID nUIID, const CID nCID, bool bReload)
...
public :
	...
	GDBT_CHAR_SAVE_SOUL_BINDING(const AID nAID, const MUID& uidPlayer, const CID nCID, const int nSoulBindingID, const int nCharPtm)
...
public :
	...
	GDBT_CHAR_REGIST_INN_ROOM(const AID nAID, const MUID& uidPlayer, const CID nCID, const int nRoomID, const int nCharPtm)
...
public :
	...
	GDBT_CHAR_MONEY_INC_DEC(const MUID& uidPlayer, AID nAID, CID nCID, int nCode, int nCharPtm, int nDeltaCharPtm, int nLevel, int nXP, int nMoney, int nDeltaMoney, bool bRouteParty, int nNpcID)
...
public :
	...
	GDBT_CHAR_KILL(AID nAID, const MUID& uidPlayer, CID nCID, int nCode, int nCharPtm, int nDeltaCharPtm, int nLevel, int nXP, int nFieldID, const vec3& vPos) 
