...
{
public :
	GDBT_ITEM_XP_DATA() : m_nAID(0), m_uidPlayer(0), m_uidItem(0), m_nCID(0), m_strRegDate(L"NULL"), m_nXP(0), m_nModXP(0), m_nNpcID(0) {}
	GDBT_ITEM_XP_DATA(const int64 nAID, const MUID& uidPlayer, const int64& uidItem, const int64 nCID, const wstring& strRegDate, const int nXP, const int nNextAttuneXP, const int nModXP, int nNpcID)
		: m_nAID(nAID), m_uidPlayer(uidPlayer), m_uidItem(uidItem), m_nCID(0), m_strRegDate(strRegDate), m_nXP(nXP), m_nNextLvlXP(nNextAttuneXP), m_nModXP(nModXP), m_nNpcID(nNpcID) {}
