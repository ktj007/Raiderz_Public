...
public :
	...
	GDBT_NPC_SHOP_TRADE_DATA(const AID nAID, const MUID& uidPlayer, int nDeltaCharPtm, uint8 nLevel, const int nxP, const int nMoney, const int nModMoney, const int16 nModStackAmt, const int nAddExpiMin) 
...
public :
	...
	GDBT_SELL_ITEM_VERY_COMMON(const AID nAID, const MUID& uidPlayer, const CID nCID, int nDeltaCharPtm, uint8 nLevel, const int nXP, const int nMoney, const int nModMoney, const int nCharPtm, GITEM_STACK_AMT_VEC& vVeryComm)
...
public :
	...
	GDBT_ITEM_REPAIR_CHAR(const AID nAID, const CID nCID, const int nCharPtm, int nDeltaCharPtm, uint8 nLevel, const int nXP, const int nMoney, const int nModMoney)
...
public :
	...
	GDBT_REPAIR_ITEM(const AID nAID, const MUID& uidPlayer, const CID nCID
...
public :
	...
	GDBT_REPAIR_ALL_ITEM(const AID nAID, const MUID& uidPlayer, const CID nCID, const int nMoney, const int nModMoney, const int nXP, const int nCharPtm, int nDeltaCharPtm, uint8 nLevel, GDBT_ITEM_REPAIR_VEC& vRepair)
