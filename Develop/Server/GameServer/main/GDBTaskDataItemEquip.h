...
struct GDBT_ITEM_EQUIP
{
	...
	GDBT_ITEM_EQUIP(MUID uidPlayer, CID nCID, GDBT_EQUIP_ITEM_SLOT& equip, GDBT_UNEQUIP_ITEM_SLOT& unequip1, GDBT_UNEQUIP_ITEM_SLOT& unequip2);
};
...
struct GDBT_ITEM_UNEQUIP
{
	...
	GDBT_ITEM_UNEQUIP(MUID uidPlayer, CID nCID, GDBT_UNEQUIP_ITEM_SLOT& unequip1, GDBT_UNEQUIP_ITEM_SLOT& unequip2);
};