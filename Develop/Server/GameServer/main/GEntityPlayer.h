...
private:
	...
	virtual void CalcNewCells( vector<GFieldGrid::Sector*>& vecNewSectors, MPoint ptOldSec, MPoint ptNewSec ) const;
...
public:
	...
	void MakeTDCacheInfo(TD_UPDATE_CACHE_PLAYER& cache, TD_PLAYER_FEATURE_TATTOO& TattooCache);	
