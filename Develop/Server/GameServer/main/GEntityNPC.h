...
private:
	...
	virtual void OnSectorChanged( const vector<GFieldGrid::Sector*>& vecNewSectors, const vector<GFieldGrid::Sector*>& vecOldSectors );	//todo 제거예정
public:
...
public:
	...
	void SendNPCIcon();
	void SendNPCIconBySectorChange( const vector<GFieldGrid::Sector*>& vecNewSectors );
};
