...
bool GDBManager::TradeMarketPutOn(const GDBT_TRADEMARKET_PUT_ON& data)
{
	GDBTaskTradeMarketPutOn* pTask = new GDBTaskTradeMarketPutOn(data.playerUID);
	VALID_RET(NULL!=pTask, false);
