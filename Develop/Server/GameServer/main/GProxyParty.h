...
{
public:
	GProxyParty(MUID uidParty, MUID uidLeader, wstring strLeaderName, CID nLeaderCID);
	virtual ~GProxyParty();

	void AddMember(MUID uidMember, wstring strMemberName, CID nMemberCID);
	...
	CID GetCID(MUID uidMember) const;
	int GetCount(void) const;	
	bool IsFull(void) const;
	MUID Find(wstring strName) const;
	MUID Find(CID nCID) const;
...
public:
	...
	GProxyParty* AddParty(MUID uidParty, MUID uidLeader, wstring strLeaderName, CID nLeaderCID);
