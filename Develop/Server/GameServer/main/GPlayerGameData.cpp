...
void GPlayerGameData::PackCharaInfo(GEntityPlayer* pEntityPlayer)
{
	...
	m_CharaInfoData.nEyeColor = pPlayerInfo->nEyeColor;

	m_CharaInfoData.nMakeUp = pPlayerInfo->nMakeUp;
	m_CharaInfoData.nTattooType = pPlayerInfo->nTattooType;
	m_CharaInfoData.nTattooPosX = pPlayerInfo->nTattooPosX;
	m_CharaInfoData.nTattooPosY = pPlayerInfo->nTattooPosY;
	m_CharaInfoData.nTattooScale = pPlayerInfo->nTattooScale;
...
void GPlayerGameData::UnpackCharaInfo_Pre(GEntityPlayer* pPlayer)
{
	...
	pPlayerInfo->nEyeColor			= m_CharaInfoData.nEyeColor;
	pPlayerInfo->nMakeUp			= m_CharaInfoData.nMakeUp;
	pPlayerInfo->nTattooType			= m_CharaInfoData.nTattooType;
	pPlayerInfo->nTattooPosX			= m_CharaInfoData.nTattooPosX;
	pPlayerInfo->nTattooPosY			= m_CharaInfoData.nTattooPosY;
	pPlayerInfo->nTattooScale		= m_CharaInfoData.nTattooScale;
