...
SUITE(DBTEST_CHAR_CREATE)
{
	...
	public :
		...
		{
			TDBRecordSet rs;
			UTestDB.Execute(rs, L"{CALL dbo.USP_RZ_CHAR_INSERT (%d, %I64d, N'%s'\
								 , %d, %d, %d, %d, %d\
								 , %d, %d, %d, %d\
								 , %d, %d, %d, %d, %d\
								 , %d, %d, %d, %d, %d, %d\
								 ...
								 , m_FEAT_HAIR, m_FEAT_FACE, m_FEAT_HAIR_COLOR, m_FEAT_SKIN_COLOR
		...
		{
			TDBRecordSet rs;
			UTestDB.Execute(rs, L"SELECT NAME, LEV, EXP, MONEY, RACE, SEX, FEAT_HAIR, FEAT_FACE, FEAT_HAIR_COLOR, FEAT_SKIN_COLOR\
	...
	public :
		...
		uint8	m_FEAT_HAIR;
		uint8	m_FEAT_FACE;
		int16	m_FEAT_HAIR_COLOR;
		int16	m_FEAT_SKIN_COLOR;
		uint8	m_TATOO;
		short	m_TATOO_POS_X;
		short	m_TATOO_POS_Y;
		uint8	m_TATOO_SCALE;
