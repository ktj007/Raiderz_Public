...
#define IMG_BMPTITLEDEFAULT						180, 42
#define SIZE_BMPTITLEDEFAULT					123, 20
...
#define SIZE_ABOUTBUTTONDEFAULT					16,  16

// Minimize button의 이미지 좌표 및 크기
#define IMG_MINIMIZEBUTTONDEFAULT				260, 0
#define SIZE_MINIMIZEBUTTONDEFAULT				16,  16

// Maximize button의 이미지 좌표 및 크기
#define IMG_MAXIMIZEBUTTONDEFAULT				192, 17
#define SIZE_MAXIMIZEBUTTONDEFAULT				16,  16

// Quit button의 이미지 좌표 및 크기
#define IMG_QUITBUTTONDEFAULT					260, 17
#define SIZE_QUITBUTTONDEFAULT					16,  16
...
void CDDBDialog::SetWindowText( LPCTSTR lpszString)
{
	...
	if ( m_DlgInfo.bUseTitlebar)
	{
		...
		m_Screen.FillTiledBitmap( (int)(m_DlgInfo.nWidth*0.2f), 1, m_DlgInfo.nWidth-(int)(m_DlgInfo.nWidth*0.2f*2.0f), GetY(SIZE_CAPTIONBARDEFAULT), m_Skin.GetDC(), GetX(IMG_CAPTIONBARDEFAULT)+GetX(SIZE_CAPTIONBARDEFAULT)+1, GetY(IMG_CAPTIONBARDEFAULT), SIZE_CAPTIONBARDEFAULT);
		m_Screen.PutBitmap( (int)(m_DlgInfo.nWidth*0.2f), 1, m_Skin.GetDC(), IMG_CAPTIONBARDEFAULT, SIZE_CAPTIONBARDEFAULT, SRCCOPY);
		m_Screen.PutBitmap( m_DlgInfo.nWidth-(int)(m_DlgInfo.nWidth*0.2f)-GetX(SIZE_CAPTIONBARDEFAULT), 1, m_Skin.GetDC(), GetX(IMG_CAPTIONBARDEFAULT)+GetX(SIZE_CAPTIONBARDEFAULT)+1+GetX(SIZE_CAPTIONBARDEFAULT)+1, GetY(IMG_CAPTIONBARDEFAULT), SIZE_CAPTIONBARDEFAULT, SRCCOPY);
...
void CDDBDialog::CreateTrayicon( LPCTSTR lpszTooltip)
{
	...
	strcpy_s( m_TrayIcon.szTip, lpszTooltip);
