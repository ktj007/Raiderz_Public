...
protected:
	...
	INT64		m_nTotalDownloadSize;
	INT64		m_nCurrDownloadSize;
...
public:
	...
	INT64 GetTotalDownloadSize()						{ return m_nTotalDownloadSize; }
	void SetTotalDownloadSize( INT64 nSize)				{ m_nTotalDownloadSize = nSize; }
	void AddTotalDownloadSize( INT64 nSize)				{ m_nTotalDownloadSize += nSize; }
	void ClearTotalDownloadSize()								{ m_nTotalDownloadSize = 0; }

	INT64 GetCurrDownloadSize()							{ return m_nCurrDownloadSize; }
	void SetCurrDownloadSize( INT64 nSize)				{ m_nCurrDownloadSize = nSize; }
	void AddCurrDownloadSize( INT64 nSize)				{ m_nCurrDownloadSize += nSize; }
...
public:
	...
	bool DownloadFile( const char* pszRemoteFileName, const char* pszLocalFileName, INT64 nFileSize);
