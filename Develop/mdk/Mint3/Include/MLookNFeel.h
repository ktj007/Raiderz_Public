...
// 아무것도 그리지 않는 룩을 등록할 수 있도록 합니다.
#define DECLARE_NULL_LOOK(CLASS_LOOK)							\
private:														\
	static CLASS_LOOK	m_NullLook;								\
public:															\
	void ChangeLookToNull(){									\
		m_pCustomLook = &m_NullLook;							\
	}	
...
// Look&Feel Implementation
#define IMPLEMENT_NULL_LOOK(CLASS, CLASS_LOOK)					\
	CLASS_LOOK CLASS::m_NullLook;							
