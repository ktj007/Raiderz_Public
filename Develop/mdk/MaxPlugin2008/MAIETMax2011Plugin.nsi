...
;Configuration
  ...
  ;General
  Name "MAIET entertainment - 3ds Max 2011 Export Plugins ${__DATE__}"
  OutFile "..\..\Game\Runtime\Dev\MAIETExporters\MAIET3dsmax2011Exporters.exe"
  CRCCheck on
