...
;Configuration
  ...
  ;General
  Name "MAIET entertainment - 3ds Max 2009 Export Plugins ${__DATE__}"
  OutFile "..\..\Game\Runtime\Dev\MAIETExporters\MAIET3dsmax2009Exporters.exe"
  CRCCheck on
