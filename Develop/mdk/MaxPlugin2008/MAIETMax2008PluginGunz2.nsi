...
;Configuration
  ...
  ;General
  Name "MAIET entertainment - 3ds Max 2008 PhysX Plugin ${__DATE__}"
  OutFile "..\..\Game\Runtime\Dev\MAIETExporters\MAIETMax2008PluginGunz2.exe"
  CRCCheck on
...
Section "Uninstall" SecUninstall
  ...
  Delete "$INSTDIR\pxplugin2008.dlm"
