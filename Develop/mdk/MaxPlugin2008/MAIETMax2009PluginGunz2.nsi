...
;Configuration
  ...
  ;General
  Name "MAIET entertainment - 3ds Max 2009 PhysX Plugin ${__DATE__}"
  OutFile "..\..\Game\Runtime\Dev\MAIETExporters\MAIETMax2009PluginGunz2.exe"
  CRCCheck on
  ...
  InstallDirRegKey HKLM "Software\Autodesk\3dsmax\11.0\MAX-1:409" "Installdir"
...
Section "Uninstall" SecUninstall
  ...
  Delete "$INSTDIR\pxplugin2009.dlm"
