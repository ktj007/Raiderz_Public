...
public:
	...
	CRTTI(	int dwStub, ClassID CLID, const char* szClassName, CRTTI* pBaseClassRTTI, 
	...
	CAbstractProperty*		FindProperty( const char* szPropertyName );
