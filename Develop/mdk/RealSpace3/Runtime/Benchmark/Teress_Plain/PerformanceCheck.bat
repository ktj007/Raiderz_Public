...
..\PIXWin.exe PerformanceCheck.PIXExp -targetpath ..\RS3Benchmark.exe -targetstartfolder .\ -targetargs PerformanceCheck.config.xml -runfile Teress_Plain/PerformanceCheck.PIXRun -start
