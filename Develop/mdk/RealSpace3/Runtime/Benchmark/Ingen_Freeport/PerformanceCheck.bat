...
..\PIXWin.exe PerformanceCheck.PIXExp -targetpath ..\RS3Benchmark.exe -targetstartfolder .\ -targetargs PerformanceCheck.config.xml -runfile Ingen_Freeport/PerformanceCheck.PIXRun -start
