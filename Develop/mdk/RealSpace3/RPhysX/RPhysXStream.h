...
class RPhysXStream : public NxStream
{
public:
								RPhysXStream(const char* filename, bool load);
	virtual						~RPhysXStream();
...
class RPhysXMemoryWriteBuffer : public NxStream
{
	public:
								RPhysXMemoryWriteBuffer();
	virtual						~RPhysXMemoryWriteBuffer();
...
class RPhysXMemoryReadBuffer : public NxStream
{
	public:
								RPhysXMemoryReadBuffer(const NxU8* data);
	virtual						~RPhysXMemoryReadBuffer();
