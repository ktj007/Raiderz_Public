========================================================================
    Win32 응용 프로그램 : rs3IK 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 rs3IK 응용 프로그램을 만들었습니다.  
이 파일에는 rs3IK 응용 프로그램을 구성하는 각각의 파일에
...
rs3IK.ico
    ...
    해당 아이콘은 기본 리소스 파일인 rs3IK.rc에 의해 포함됩니다.
...
StdAfx.h 및 StdAfx.cpp는
    rs3IK.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
