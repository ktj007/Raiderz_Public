...
//**************************************************************
  for (size_t i=0; i<source->mMaterials.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mActors.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mJoints.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mPairFlags.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mEffectors.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mForceFields.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mCollisionGroups.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mActorGroups.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mCompartments.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mFluids.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mCloths.size(); ++i)
  {
...
//**************************************************************
  for (size_t i=0; i<source->mSoftBodies.size(); ++i)
  {
...
void copyTriangleMeshScaled(NxTriangleMeshDesc *dest,NxTriangleMeshDesc *source,const NxVec3 &scale,NxPhysicsSDK *sdk,const char *sourceId,const char *destId)
{
  if ( source->mCookedData.empty() )
  {
    ...
    for (size_t i=0; i<source->mPoints.size(); i++)
    {
...
//****************************************************************
  for (size_t i=0; i<source->mParameters.size(); ++i)
  {
...
//****************************************************************
  for (size_t i=0; i<source->mConvexMeshes.size(); ++i)
  {
...
//****************************************************************
  for (size_t i=0; i<source->mTriangleMeshes.size(); ++i)
  {
...
//****************************************************************
  for (size_t i=0; i<source->mHeightFields.size(); ++i)
  {
...
//****************************************************************
  for (size_t i=0; i<source->mSkeletons.size(); ++i)
  {
...
//****************************************************************
  for (size_t i=0; i<source->mClothMeshes.size(); ++i)
  {
...
//****************************************************************
  for (size_t i=0; i<source->mSoftBodyMeshes.size(); ++i)
  {
...
//****************************************************************
  for (size_t i=0; i<source->mScenes.size(); ++i)
  {
...
//****************************************************************
  for (size_t i=0; i<source->mSceneInstances.size(); ++i)
  {
