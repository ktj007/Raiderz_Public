...
bool         StringToEnum(const char *str,NxParameter &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_PENALTY_FORCE") == 0 ) { v = NX_PENALTY_FORCE; ret = true; }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY15") == 0 ) { v = NX_DUMMY15; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY16") == 0 ) { v = NX_DUMMY16; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY17") == 0 ) { v = NX_DUMMY17; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY18") == 0 ) { v = NX_DUMMY18; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY19") == 0 ) { v = NX_DUMMY19; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY20") == 0 ) { v = NX_DUMMY20; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY21") == 0 ) { v = NX_DUMMY21; ret = true; }
#endif
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY23") == 0 ) { v = NX_DUMMY23; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY24") == 0 ) { v = NX_DUMMY24; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY25") == 0 ) { v = NX_DUMMY25; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY26") == 0 ) { v = NX_DUMMY26; ret = true; }
#endif
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY30") == 0 ) { v = NX_DUMMY30; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY31") == 0 ) { v = NX_DUMMY31; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >=270
  else if ( _stricmp(str,"NX_DUMMY32") == 0 ) { v = NX_DUMMY32; ret = true; }
#endif
...
#endif
#if NX_SDK_VERSION_NUMBER >=280
  else if ( _stricmp(str,"NX_DUMMY46") == 0 ) { v = NX_DUMMY46; ret = true; }
#endif
...
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_CONSTANT_FLUID_MAX_PACKETS") == 0 ) { v = NX_CONSTANT_FLUID_MAX_PACKETS; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_CONSTANT_FLUID_MAX_PARTICLES_PER_STEP") == 0 ) { v = NX_CONSTANT_FLUID_MAX_PARTICLES_PER_STEP; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER == 250 || NX_SDK_VERSION_NUMBER == 251
  else if ( _stricmp(str,"NX_GRID_HASH_CELL_SIZE") == 0 ) { v = NX_GRID_HASH_CELL_SIZE; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_CLOTH_TEARABLE_VERTICES") == 0 ) { v = NX_VISUALIZE_CLOTH_TEARABLE_VERTICES; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_CLOTH_TEARING") == 0 ) { v = NX_VISUALIZE_CLOTH_TEARING; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_CLOTH_ATTACHMENT") == 0 ) { v = NX_VISUALIZE_CLOTH_ATTACHMENT; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_SOFTBODY_MESH") == 0 ) { v = NX_VISUALIZE_SOFTBODY_MESH; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_SOFTBODY_COLLISIONS") == 0 ) { v = NX_VISUALIZE_SOFTBODY_COLLISIONS; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_SOFTBODY_WORKPACKETS") == 0 ) { v = NX_VISUALIZE_SOFTBODY_WORKPACKETS; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_SOFTBODY_SLEEP") == 0 ) { v = NX_VISUALIZE_SOFTBODY_SLEEP; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_SOFTBODY_TEARABLE_VERTICES") == 0 ) { v = NX_VISUALIZE_SOFTBODY_TEARABLE_VERTICES; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_SOFTBODY_TEARING") == 0 ) { v = NX_VISUALIZE_SOFTBODY_TEARING; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_SOFTBODY_ATTACHMENT") == 0 ) { v = NX_VISUALIZE_SOFTBODY_ATTACHMENT; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_VISUALIZE_FLUID_PACKET_DATA") == 0 ) { v = NX_VISUALIZE_FLUID_PACKET_DATA; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_VISUALIZE_FORCE_FIELDS") == 0 ) { v = NX_VISUALIZE_FORCE_FIELDS; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_VISUALIZE_CLOTH_VALIDBOUNDS") == 0 ) { v = NX_VISUALIZE_CLOTH_VALIDBOUNDS; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_VISUALIZE_SOFTBODY_VALIDBOUNDS") == 0 ) { v = NX_VISUALIZE_SOFTBODY_VALIDBOUNDS; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_VISUALIZE_CLOTH_SLEEP_VERTEX") == 0 ) { v = NX_VISUALIZE_CLOTH_SLEEP_VERTEX; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_VISUALIZE_SOFTBODY_SLEEP_VERTEX") == 0 ) { v = NX_VISUALIZE_SOFTBODY_SLEEP_VERTEX; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_ASYNCHRONOUS_MESH_CREATION") == 0 ) { v = NX_ASYNCHRONOUS_MESH_CREATION; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FORCE_FIELD_CUSTOM_KERNEL_EPSILON") == 0 ) { v = NX_FORCE_FIELD_CUSTOM_KERNEL_EPSILON; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 281
  else if ( _stricmp(str,"NX_IMPROVED_SPRING_SOLVER") == 0 ) { v = NX_IMPROVED_SPRING_SOLVER; ret = true; }
#endif
...
bool         StringToEnum(const char *str,NxCompartmentType &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SCT_RIGIDBODY") == 0 ) { v = NX_SCT_RIGIDBODY; ret = true; }
...
bool         StringToEnum(const char *str,NxPruningStructure &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_PRUNING_NONE") == 0 ) { v = NX_PRUNING_NONE; ret = true; }
...
bool         StringToEnum(const char *str,NxBroadPhaseType &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_BP_TYPE_SAP_SINGLE") == 0 ) { v = NX_BP_TYPE_SAP_SINGLE; ret = true; }
  else if ( _stricmp(str,"NX_BP_TYPE_SAP_MULTI") == 0 ) { v = NX_BP_TYPE_SAP_MULTI; ret = true; }
  }
  return ret;
}
#endif
...
bool         StringToEnum(const char *str,NxCompartmentFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_CF_SLEEP_NOTIFICATION") == 0 ) { v = NX_CF_SLEEP_NOTIFICATION; ret = true; }
#if NX_SDK_VERSION_NUMBER >= 271
  else if ( _stricmp(str,"NX_CF_CONTINUOUS_CD") == 0 ) { v = NX_CF_CONTINUOUS_CD; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 271
  else if ( _stricmp(str,"NX_CF_RESTRICTED_SCENE") == 0 ) { v = NX_CF_RESTRICTED_SCENE; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 271
  else if ( _stricmp(str,"NX_CF_INHERIT_SETTINGS") == 0 ) { v = NX_CF_INHERIT_SETTINGS; ret = true; }
#endif
  return ret;
}
#endif
...
bool         StringToEnum(const char *str,NxConvexFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_CF_FLIPNORMALS") == 0 ) { v = NX_CF_FLIPNORMALS; ret = true; }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_CF_DUMMY4") == 0 ) { v = NX_CF_DUMMY4; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 250
...
bool         StringToEnum(const char *str,NxHeightFieldAxis &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_X") == 0 ) { v = NX_X; ret = true; }
...
bool         StringToEnum(const char *str,NxMeshFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_MF_FLIPNORMALS") == 0 ) { v = NX_MF_FLIPNORMALS; ret = true; }
...
bool         StringToEnum(const char *str,NxHeightFieldFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_HF_NO_BOUNDARY_EDGES") == 0 ) { v = NX_HF_NO_BOUNDARY_EDGES; ret = true; }
  return ret;
}
...
bool         StringToEnum(const char *str,NxClothMeshFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_CLOTH_MESH_DUMMY0") == 0 ) { v = NX_CLOTH_MESH_DUMMY0; ret = true; }
...
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_CLOTH_MESH_WELD_VERTICES") == 0 ) { v = NX_CLOTH_MESH_WELD_VERTICES; ret = true; }
#endif
  return ret;
}
#endif
...
bool         StringToEnum(const char *str,NxClothVertexFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_CLOTH_VERTEX_DUMMY0") == 0 ) { v = NX_CLOTH_VERTEX_DUMMY0; ret = true; }
...
bool         StringToEnum(const char *str,NxFilterOp &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_FILTEROP_AND") == 0 ) { v = NX_FILTEROP_AND; ret = true; }
...
bool         StringToEnum(const char *str,NxTimeStepMethod &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_TIMESTEP_FIXED") == 0 ) { v = NX_TIMESTEP_FIXED; ret = true; }
...
bool         StringToEnum(const char *str,NxSimulationType &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SIMULATION_SW") == 0 ) { v = NX_SIMULATION_SW; ret = true; }
...
bool         StringToEnum(const char *str,NxThreadPriority &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_TP_HIGH") == 0 ) { v = NX_TP_HIGH; ret = true; }
#if NX_SDK_VERSION_NUMBER >= 271
  else if ( _stricmp(str,"NX_TP_ABOVE_NORMAL") == 0 ) { v = NX_TP_ABOVE_NORMAL; ret = true; }
#endif
  else if ( _stricmp(str,"NX_TP_NORMAL") == 0 ) { v = NX_TP_NORMAL; ret = true; }
#if NX_SDK_VERSION_NUMBER >= 271
  else if ( _stricmp(str,"NX_TP_BELOW_NORMAL") == 0 ) { v = NX_TP_BELOW_NORMAL; ret = true; }
#endif
...
bool         StringToEnum(const char *str,NxSceneFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SF_DISABLE_SSE") == 0 ) { v = NX_SF_DISABLE_SSE; ret = true; }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 263
  else if ( _stricmp(str,"NX_SF_SEQUENTIAL_PRIMARY") == 0 ) { v = NX_SF_SEQUENTIAL_PRIMARY; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 263
  else if ( _stricmp(str,"NX_SF_FLUID_PERFORMANCE_HINT") == 0 ) { v = NX_SF_FLUID_PERFORMANCE_HINT; ret = true; }
#endif
  return ret;
}
...
bool         StringToEnum(const char *str,NxCombineMode &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_CM_AVERAGE") == 0 ) { v = NX_CM_AVERAGE; ret = true; }
...
bool         StringToEnum(const char *str,NxMaterialFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_MF_ANISOTROPIC") == 0 ) { v = NX_MF_ANISOTROPIC; ret = true; }
...
bool         StringToEnum(const char *str,NxBodyFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_BF_DISABLE_GRAVITY") == 0 ) { v = NX_BF_DISABLE_GRAVITY; ret = true; }
  ...
  else if ( _stricmp(str,"NX_BF_DUMMY_0") == 0 ) { v = NX_BF_DUMMY_0; ret = true; }
...
bool         StringToEnum(const char *str,NxActorFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_AF_DISABLE_COLLISION") == 0 ) { v = NX_AF_DISABLE_COLLISION; ret = true; }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_AF_USER_ACTOR_PAIR_FILTERING") == 0 ) { v = NX_AF_USER_ACTOR_PAIR_FILTERING; ret = true; }
#endif
  return ret;
}
...
bool         StringToEnum(const char *str,NxShapeType &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SHAPE_PLANE") == 0 ) { v = NX_SHAPE_PLANE; ret = true; }
...
bool         StringToEnum(const char *str,NxShapeCompartmentType &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_COMPARTMENT_SW_RIGIDBODY") == 0 ) { v = NX_COMPARTMENT_SW_RIGIDBODY; ret = true; }
  else if ( _stricmp(str,"NX_COMPARTMENT_HW_RIGIDBODY") == 0 ) { v = NX_COMPARTMENT_HW_RIGIDBODY; ret = true; }
  else if ( _stricmp(str,"NX_COMPARTMENT_SW_FLUID") == 0 ) { v = NX_COMPARTMENT_SW_FLUID; ret = true; }
  else if ( _stricmp(str,"NX_COMPARTMENT_HW_FLUID") == 0 ) { v = NX_COMPARTMENT_HW_FLUID; ret = true; }
  else if ( _stricmp(str,"NX_COMPARTMENT_SW_CLOTH") == 0 ) { v = NX_COMPARTMENT_SW_CLOTH; ret = true; }
  else if ( _stricmp(str,"NX_COMPARTMENT_HW_CLOTH") == 0 ) { v = NX_COMPARTMENT_HW_CLOTH; ret = true; }
  else if ( _stricmp(str,"NX_COMPARTMENT_SW_SOFTBODY") == 0 ) { v = NX_COMPARTMENT_SW_SOFTBODY; ret = true; }
  else if ( _stricmp(str,"NX_COMPARTMENT_HW_SOFTBODY") == 0 ) { v = NX_COMPARTMENT_HW_SOFTBODY; ret = true; }
  return ret;
}
#endif
...
bool         StringToEnum(const char *str,NxShapeFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_TRIGGER_ON_ENTER") == 0 ) { v = NX_TRIGGER_ON_ENTER; ret = true; }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_SF_CLOTH_DRAIN") == 0 ) { v = NX_SF_CLOTH_DRAIN; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_SF_CLOTH_DISABLE_COLLISION") == 0 ) { v = NX_SF_CLOTH_DISABLE_COLLISION; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_SF_CLOTH_TWOWAY") == 0 ) { v = NX_SF_CLOTH_TWOWAY; ret = true; }
#endif
#if NX_USE_SOFTBODY_API
  else if ( _stricmp(str,"NX_SF_SOFTBODY_DRAIN") == 0 ) { v = NX_SF_SOFTBODY_DRAIN; ret = true; }
#endif
#if NX_USE_SOFTBODY_API
  else if ( _stricmp(str,"NX_SF_SOFTBODY_DISABLE_COLLISION") == 0 ) { v = NX_SF_SOFTBODY_DISABLE_COLLISION; ret = true; }
#endif
#if NX_USE_SOFTBODY_API
  else if ( _stricmp(str,"NX_SF_SOFTBODY_TWOWAY") == 0 ) { v = NX_SF_SOFTBODY_TWOWAY; ret = true; }
#endif
  return ret;
}
...
bool         StringToEnum(const char *str,NxCapsuleShapeFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SWEPT_SHAPE") == 0 ) { v = NX_SWEPT_SHAPE; ret = true; }
  return ret;
}
...
bool         StringToEnum(const char *str,NxWheelShapeFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_WF_WHEEL_AXIS_CONTACT_NORMAL") == 0 ) { v = NX_WF_WHEEL_AXIS_CONTACT_NORMAL; ret = true; }
...
bool         StringToEnum(const char *str,NxMeshPagingMode &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_MESH_PAGING_MANUAL") == 0 ) { v = NX_MESH_PAGING_MANUAL; ret = true; }
...
bool         StringToEnum(const char *str,NxMeshShapeFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_MESH_SMOOTH_SPHERE_COLLISIONS") == 0 ) { v = NX_MESH_SMOOTH_SPHERE_COLLISIONS; ret = true; }
...
bool         StringToEnum(const char *str,NxJointType &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_JOINT_PRISMATIC") == 0 ) { v = NX_JOINT_PRISMATIC; ret = true; }
...
bool         StringToEnum(const char *str,NxJointFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_JF_COLLISION_ENABLED") == 0 ) { v = NX_JF_COLLISION_ENABLED; ret = true; }
...
bool         StringToEnum(const char *str,NxD6JointMotion &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_D6JOINT_MOTION_LOCKED") == 0 ) { v = NX_D6JOINT_MOTION_LOCKED; ret = true; }
...
bool         StringToEnum(const char *str,NxD6JointDriveType &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_D6JOINT_DRIVE_POSITION") == 0 ) { v = NX_D6JOINT_DRIVE_POSITION; ret = true; }
...
bool         StringToEnum(const char *str,NxJointProjectionMode &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_JPM_NONE") == 0 ) { v = NX_JPM_NONE; ret = true; }
...
bool         StringToEnum(const char *str,NxD6JointFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_D6JOINT_SLERP_DRIVE") == 0 ) { v = NX_D6JOINT_SLERP_DRIVE; ret = true; }
...
bool         StringToEnum(const char *str,NxDistanceJointFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_DJF_MAX_DISTANCE_ENABLED") == 0 ) { v = NX_DJF_MAX_DISTANCE_ENABLED; ret = true; }
...
bool         StringToEnum(const char *str,NxRevoluteJointFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_RJF_LIMIT_ENABLED") == 0 ) { v = NX_RJF_LIMIT_ENABLED; ret = true; }
...
bool         StringToEnum(const char *str,NxSphericalJointFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SJF_TWIST_LIMIT_ENABLED") == 0 ) { v = NX_SJF_TWIST_LIMIT_ENABLED; ret = true; }
...
#if NX_SDK_VERSION_NUMBER >= 281
  else if ( _stricmp(str,"NX_SJF_PERPENDICULAR_DIR_CONSTRAINTS") == 0 ) { v = NX_SJF_PERPENDICULAR_DIR_CONSTRAINTS; ret = true; }
#endif
  return ret;
}
...
bool         StringToEnum(const char *str,NxPulleyJointFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_PJF_IS_RIGID") == 0 ) { v = NX_PJF_IS_RIGID; ret = true; }
...
bool         StringToEnum(const char *str,NxContactPairFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_IGNORE_PAIR") == 0 ) { v = NX_IGNORE_PAIR; ret = true; }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_NOTIFY_ON_START_TOUCH_FORCE_THRESHOLD") == 0 ) { v = NX_NOTIFY_ON_START_TOUCH_FORCE_THRESHOLD; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_NOTIFY_ON_END_TOUCH_FORCE_THRESHOLD") == 0 ) { v = NX_NOTIFY_ON_END_TOUCH_FORCE_THRESHOLD; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_NOTIFY_ON_TOUCH_FORCE_THRESHOLD") == 0 ) { v = NX_NOTIFY_ON_TOUCH_FORCE_THRESHOLD; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 250
...
bool         StringToEnum(const char *str,NxFluidSimulationMethod &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_F_SPH") == 0 ) { v = NX_F_SPH; ret = true; }
...
bool         StringToEnum(const char *str,NxFluidCollisionMethod &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_F_STATIC") == 0 ) { v = NX_F_STATIC; ret = true; }
...
bool         StringToEnum(const char *str,NxFluidFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_FF_VISUALIZATION") == 0 ) { v = NX_FF_VISUALIZATION; ret = true; }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_FF_PRIORITY_MODE") == 0 ) { v = NX_FF_PRIORITY_MODE; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FF_PROJECT_TO_PLANE") == 0 ) { v = NX_FF_PROJECT_TO_PLANE; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FF_FORCE_STRICT_COOKING_FORMAT") == 0 ) { v = NX_FF_FORCE_STRICT_COOKING_FORMAT; ret = true; }
#endif
  return ret;
}
#endif
...
bool         StringToEnum(const char *str,NxEmitterType &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_FE_CONSTANT_PRESSURE") == 0 ) { v = NX_FE_CONSTANT_PRESSURE; ret = true; }
...
bool         StringToEnum(const char *str,NxEmitterShape &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_FE_RECTANGULAR") == 0 ) { v = NX_FE_RECTANGULAR; ret = true; }
...
bool         StringToEnum(const char *str,NxFluidEmitterFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_FEF_VISUALIZATION") == 0 ) { v = NX_FEF_VISUALIZATION; ret = true; }
#if NX_SDK_VERSION_NUMBER < 250
...
bool         StringToEnum(const char *str,NxClothFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_CLF_PRESSURE") == 0 ) { v = NX_CLF_PRESSURE; ret = true; }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_CLF_VALIDBOUNDS") == 0 ) { v = NX_CLF_VALIDBOUNDS; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 270
  else if ( _stricmp(str,"NX_CLF_FLUID_COLLISION") == 0 ) { v = NX_CLF_FLUID_COLLISION; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_CLF_DISABLE_DYNAMIC_CCD") == 0 ) { v = NX_CLF_DISABLE_DYNAMIC_CCD; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_CLF_ADHERE") == 0 ) { v = NX_CLF_ADHERE; ret = true; }
#endif
  return ret;
}
...
bool         StringToEnum(const char *str,NxForceFieldCoordinates &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_FFC_CARTESIAN") == 0 ) { v = NX_FFC_CARTESIAN; ret = true; }
  else if ( _stricmp(str,"NX_FFC_SPHERICAL") == 0 ) { v = NX_FFC_SPHERICAL; ret = true; }
  else if ( _stricmp(str,"NX_FFC_CYLINDRICAL") == 0 ) { v = NX_FFC_CYLINDRICAL; ret = true; }
  else if ( _stricmp(str,"NX_FFC_TOROIDAL") == 0 ) { v = NX_FFC_TOROIDAL; ret = true; }
  }
  return ret;
}
#endif
...
bool         StringToEnum(const char *str,NxForceFieldType &v)
{
  ...
  if ( str )
  {
	if (0) { assert (0); } 
#if NX_SDK_VERSION_NUMBER >= 273 && NX_SDK_VERSION_NUMBER != 274
  else if ( _stricmp(str,"NX_FF_TYPE_DUMMY_0") == 0 ) { v = NX_FF_TYPE_DUMMY_0; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 273 && NX_SDK_VERSION_NUMBER != 274
  else if ( _stricmp(str,"NX_FF_TYPE_DUMMY_1") == 0 ) { v = NX_FF_TYPE_DUMMY_1; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FF_TYPE_GRAVITATIONAL") == 0 ) { v = NX_FF_TYPE_GRAVITATIONAL; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FF_TYPE_OTHER") == 0 ) { v = NX_FF_TYPE_OTHER; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FF_TYPE_NO_INTERACTION") == 0 ) { v = NX_FF_TYPE_NO_INTERACTION; ret = true; }
#endif
  }
  return ret;
}
...
bool         StringToEnum(const char *str,NxForceFieldFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_FFF_DUMMY_0") == 0 ) { v = NX_FFF_DUMMY_0; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_FFF_DUMMY_1") == 0 ) { v = NX_FFF_DUMMY_1; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_FFF_DUMMY_2") == 0 ) { v = NX_FFF_DUMMY_2; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_FFF_DUMMY_3") == 0 ) { v = NX_FFF_DUMMY_3; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 272
  else if ( _stricmp(str,"NX_FFF_DUMMY_4") == 0 ) { v = NX_FFF_DUMMY_4; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FFF_VOLUMETRIC_SCALING_FLUID") == 0 ) { v = NX_FFF_VOLUMETRIC_SCALING_FLUID; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FFF_VOLUMETRIC_SCALING_CLOTH") == 0 ) { v = NX_FFF_VOLUMETRIC_SCALING_CLOTH; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FFF_VOLUMETRIC_SCALING_SOFTBODY") == 0 ) { v = NX_FFF_VOLUMETRIC_SCALING_SOFTBODY; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_FFF_VOLUMETRIC_SCALING_RIGIDBODY") == 0 ) { v = NX_FFF_VOLUMETRIC_SCALING_RIGIDBODY; ret = true; }
#endif
  return ret;
}
#if NX_SDK_VERSION_NUMBER >= 272
...
bool         StringToEnum(const char *str,NxForceFieldShapeGroupFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_FFSG_EXCLUDE_GROUP") == 0 ) { v = NX_FFSG_EXCLUDE_GROUP; ret = true; }
  return ret;
}
#if NX_SDK_VERSION_NUMBER >= 280
...
bool         StringToEnum(const char *str,NxSoftBodyMeshFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SOFTBODY_MESH_DUMMY") == 0 ) { v = NX_SOFTBODY_MESH_DUMMY; ret = true; }
...
bool         StringToEnum(const char *str,NxSoftBodyVertexFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SOFTBODY_VERTEX_DUMMY0") == 0 ) { v = NX_SOFTBODY_VERTEX_DUMMY0; ret = true; }
...
bool         StringToEnum(const char *str,NxSoftBodyFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SBF_DUMMY0") == 0 ) { v = NX_SBF_DUMMY0; ret = true; }
  ...
  else if ( _stricmp(str,"NX_SBF_VALIDBOUNDS") == 0 ) { v = NX_SBF_VALIDBOUNDS; ret = true; }
  else if ( _stricmp(str,"NX_SBF_FLUID_COLLISION") == 0 ) { v = NX_SBF_FLUID_COLLISION; ret = true; }
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_SBF_DISABLE_DYNAMIC_CCD") == 0 ) { v = NX_SBF_DISABLE_DYNAMIC_CCD; ret = true; }
#endif
#if NX_SDK_VERSION_NUMBER >= 280
  else if ( _stricmp(str,"NX_SBF_ADHERE") == 0 ) { v = NX_SBF_ADHERE; ret = true; }
#endif
  return ret;
}
#endif
...
bool         StringToEnum(const char *str,NxSoftBodyAttachmentFlag &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_SOFTBODY_ATTACHMENT_TWOWAY") == 0 ) { v = NX_SOFTBODY_ATTACHMENT_TWOWAY; ret = true; }
...
bool         StringToEnum(const char *str,NxMeshDataFlags &v)
{
  bool ret = false;
	if (0) { assert (0); } 
  else if ( _stricmp(str,"NX_MDF_16_BIT_INDICES") == 0 ) { v = NX_MDF_16_BIT_INDICES; ret = true; }
  return ret;
}
...
bool         StringToEnum(const char *str,SCHEMA_CLASS &v)
{
  ...
  {
	if (0) { assert (0); } 
  else if ( _stricmp(str,"SC_NXUSTREAM2") == 0 ) { v = SC_NXUSTREAM2; ret = true; }
  else if ( _stricmp(str,"SC_NxCompartmentFlag") == 0 ) { v = SC_NxCompartmentFlag; ret = true; }
  ...
  else if ( _stricmp(str,"SC_NxConstraintDominanceDesc") == 0 ) { v = SC_NxConstraintDominanceDesc; ret = true; }
  ...
  else if ( _stricmp(str,"SC_NxShapeCompartmentType") == 0 ) { v = SC_NxShapeCompartmentType; ret = true; }
  ...
  else if ( _stricmp(str,"SC_NxForceFieldFlags") == 0 ) { v = SC_NxForceFieldFlags; ret = true; }
  else if ( _stricmp(str,"SC_NxForceFieldShapeDesc") == 0 ) { v = SC_NxForceFieldShapeDesc; ret = true; }
  else if ( _stricmp(str,"SC_NxBoxForceFieldShapeDesc") == 0 ) { v = SC_NxBoxForceFieldShapeDesc; ret = true; }
  else if ( _stricmp(str,"SC_NxSphereForceFieldShapeDesc") == 0 ) { v = SC_NxSphereForceFieldShapeDesc; ret = true; }
  else if ( _stricmp(str,"SC_NxCapsuleForceFieldShapeDesc") == 0 ) { v = SC_NxCapsuleForceFieldShapeDesc; ret = true; }
  else if ( _stricmp(str,"SC_NxConvexForceFieldShapeDesc") == 0 ) { v = SC_NxConvexForceFieldShapeDesc; ret = true; }
  else if ( _stricmp(str,"SC_NxForceFieldShapeGroupFlags") == 0 ) { v = SC_NxForceFieldShapeGroupFlags; ret = true; }
  else if ( _stricmp(str,"SC_NxForceFieldShapeGroupDesc") == 0 ) { v = SC_NxForceFieldShapeGroupDesc; ret = true; }
  else if ( _stricmp(str,"SC_NxForceFieldLinearKernelDesc") == 0 ) { v = SC_NxForceFieldLinearKernelDesc; ret = true; }
  else if ( _stricmp(str,"SC_NxForceFieldScaleTableEntry") == 0 ) { v = SC_NxForceFieldScaleTableEntry; ret = true; }
  else if ( _stricmp(str,"SC_NxForceFieldGroupReference") == 0 ) { v = SC_NxForceFieldGroupReference; ret = true; }
  else if ( _stricmp(str,"SC_NxForceFieldDesc") == 0 ) { v = SC_NxForceFieldDesc; ret = true; }
