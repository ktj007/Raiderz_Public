...
class CORETOOL_API CWndResizer 
{
public:
  CWndResizer(void);
  ~CWndResizer(void);
private:
  ...
  public:
    ...
    void SetFixedPanel(short nFixedPanel /* 1=left/top; 2=right/bototm; other=no fixed panel */);
    short GetFixedPanel();
...
public:
  ...
  // use this method for ActiveX or ole controls
