...
/////////////////////////////////////////////////////////////////////////////
// by pok, checkbox observer
class CTreeCtrlExMCheckBoxObserver
{
public:
	CTreeCtrlExMCheckBoxObserver(){}
	virtual ~CTreeCtrlExMCheckBoxObserver(){}

	virtual void ObserveCheckBox( HTREEITEM hClickedItem ) = 0;
};

/////////////////////////////////////////////////////////////////////////////
// CTreeCtrlExM window

class CTreeCtrlExM : public CTreeCtrl
{
	DECLARE_DYNAMIC(CTreeCtrlExM)

// Construction
public:
	CTreeCtrlExM() : m_bSelectPending(FALSE), m_hClickedItem(NULL), m_hFirstSelectedItem(NULL), m_bSelectionComplete(TRUE), m_bEditLabelPending(FALSE)
...
public:
	...
	HTREEITEM GetClickedItem(){ return m_hClickedItem; }
	...
	void RegisterCheckBoxObserver( CTreeCtrlExMCheckBoxObserver* pObserver ){ m_pCheckBoxObserver = pObserver; }
...
private:
	...
	CTreeCtrlExMCheckBoxObserver* m_pCheckBoxObserver;
...
// Overrides
	...
	//{{AFX_VIRTUAL(CTreeCtrlExM)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CTreeCtrlExM() {}

	// Generated message map functions
protected:
	//{{AFX_MSG(CTreeCtrlExM)
